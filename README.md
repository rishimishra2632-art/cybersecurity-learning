...
| Day   | Topic                                    |
| ----- | ---------------------------------------- |
| 01–03 | Linux & networking fundamentals          |
| 04–06 | Nmap & host discovery                    |
| 07–09 | Port scanning & service detection        |
| 10–12 | HTTP, cURL & web basics                  |
| 13–15 | Web enumeration                          |
| 16–17 | Gobuster & HTTP status codes             |
| 18–20 | Burp Suite Proxy & Repeater              |
| 21    | URL parameter testing                    |
